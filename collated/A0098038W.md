...
```
###### ./googleSync/UnitTest/GoogleCRUDTest.java
``` java
...
```
###### ./googleSync/UnitTest/MemoriSyncTest.java
``` java
package memori.googleSync.UnitTest;
...
```
###### ./IntegrationTest/MemoriTest.java
``` java
...
```
###### ./IntegrationTest/TestSuite.java
``` java
package memori.IntegrationTest;
...
```
###### ./logic/UnitTest/MemoriCalendarTest.java
``` java
